package com.eims.myapp.common.search;
...
public class FairySearchView extends LinearLayout {
    ...
    private int cancelTextSize = getResources().getDimensionPixelSize(R.dimen.sp_16);
    private int cancelTextColor = getResources().getColor(R.color.btn_cancel_text);
    private String searchText = "";
    private int searchTextSize = getResources().getDimensionPixelSize(R.dimen.sp_16);
    ...
    private int searchViewHeight = getResources().getDimensionPixelSize(R.dimen.dp_8);

    private int maxSearchLength = -1;//输入内容最大长度（默认不设限制）
    private int searchPaddingLeft = getResources().getDimensionPixelSize(R.dimen.dp_8);
